    ...
    <div class='supplier'>
        <div class="searchbox">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item>
                    <el-input v-model="formInline.username" placeholder="账号" size="mini"></el-input>
                </el-form-item> <el-form-item>
                    <el-input v-model="formInline.name" placeholder="姓名" size="mini"></el-input>
                </el-form-item>
        ...
        <div class="tabbox">
            <el-table :data="tableData" style="width: 100%">
                ...
                </el-table-column> <el-table-column  prop="mobile" label="电话">
                </el-table-column> <el-table-column   prop="salary" label="薪酬">
                </el-table-column> <el-table-column prop="entryDate" label="入职时间">
                </el-table-column>
        ...
        <el-dialog :title="ruleForm.id ? '员工编辑' : '新增员工'" :visible.sync="dialogFormVisible">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                </el-form-item>   <el-form-item label="进货价">
...
<script>
import { staffApi, addstaffApi, editstaffinfoApi, staffinfoApi, delstaffApi } from "@/request/api"
export default {
    data() {
        return {
            formInline: {
    ...
    methods: {
        getlist() {
            staffApi(this.pageNum, this.pageSize, this.formInline).then(res => {
        ...
        submitForm(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    if (this.ruleForm.id) {
                        editstaffinfoApi(this.ruleForm.id, this.ruleForm).then(res => {
                            // console.log(res);
                        ...
                        addstaffApi(this.ruleForm).then(res => {
                            // console.log(res);
